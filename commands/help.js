...
module.exports = {
    ...
    async execute(client, message, args, Hyperz, config) {
        ...
        const page1 = new Hyperz.MessageEmbed()
            ...
            .addFields({ name: `Bot Name:`, value: `\`${client.user.username}\``, inline: true }, { name: `Bot Prefix:`, value: `\`${config["main_config"].prefix}\``, inline: true }, { name: `Server Owner:`, value: `${message.guild.owner.user.tag}`, inline: true }, { name: `Copyright:`, value: `${config["main_config"].copyright}\n \n`, inline: true }, )
            .setTimestamp()
        ...
        const page4 = new Hyperz.MessageEmbed()
            ...
            .setThumbnail(`${client.user.displayAvatarURL()}`)
            .addFields({ name: `Programming:`, value: "`Hyperz#0001` - Head Developer of the HypeBot Project." }, )
            .setTimestamp()
